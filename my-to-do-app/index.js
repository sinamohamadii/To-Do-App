                ...
                <div class="w-full h-auto rounded-xl bg-white py-3 flex flex-col gap-y-5 overflow-hidden">
                    ...
                    <div class="w-full px-5 flex justify-between items-center">
                        ...
                        <button 
                            ...
                            class="note-btn-${index} text-red-500 px-3 py-2 rounded-md hover:text-red-300" 
...
function removeNote(n) {
    ...
    let note = document.querySelectorAll(`.note-${n}`);
...
function importance(el, n) {
    ...
    let note = document.querySelector(`.note-${n}`);

    if (el.dataset.importance === "true") {
        let importNote = document.querySelectorAll(`.note-${n}`);
        let importNoteBtn = document.querySelectorAll(`.note-btn-${n}`);

        for (let i = 0; i < importNoteBtn.length; i++) {
            importNoteBtn[i].classList.remove("active-importance-btn");
            importNoteBtn[i].dataset.importance = "false";
        ...
        for (let i = 0; i < importNoteBtn.length; i++) {
            importNoteBtn[i].classList.add("active-importance-btn");
            importNoteBtn[i].dataset.importance = "true";
